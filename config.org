...
* Shell
*你都用 emacs 了，搞个终端不过分吧*

[[https://github.com/akermu/emacs-libvterm][vterm]] 提供（近乎）全功能的终端
#+begin_src emacs-lisp
(use-package vterm
  :bind
  (:map vterm-mode-map
...
[[https://github.com/jixiuf/vterm-toggle][vterm-toggle]] 方便 vterm 切换
#+begin_src emacs-lisp
...
[[https://github.com/xuchunyang/pinyin-search.el][pinyin-search]] 使用拼音首字母搜索
#+begin_src emacs-lisp
